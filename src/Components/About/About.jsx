...
I am passionate about learning new technologies and constantly improving my skills to become a proficient developer.
        <button className='flex  bg-slate-800 text-white p-2 rounded-lg  mt-5'> <a href="/resume.pdf" download="Suraj_Patidar_Resume.pdf" className='flex items-center text-sm '>Download Resume</a></button>
      </p>
